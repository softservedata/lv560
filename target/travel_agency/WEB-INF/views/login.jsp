...
<head>
    ...
    <!-- <link href="../static/styles/css/login-register_styles.min.css" rel="stylesheet"> -->
</head>
...
<form method="POST" action="${contextPath}/login" class="login-form" >
    ...
    <div class="input_container">
        <div class="input-wrapper">
            <dd class="inputbox-content">
                <input id="username" name="username" type="text" required autofocus="autofocus" />
    ...
    <div class="other-btn">
        <span class="sign-up"><a  href="${contextPath}/registration"></a></span>
    </div>
</form>
