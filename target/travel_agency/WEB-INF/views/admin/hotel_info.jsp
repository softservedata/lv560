...
<div class="major-block">
    ...
    <section class="right-sec">
        <form:form method="post" action="/admin/hotel/${hotel.id}/update" modelAttribute="hotel" id="wrap"
                   class="input-content">
            <h2>Change hotel ${hotel.name}</h2>
            <form:hidden path="id"/>
        ...
        <div class="delete-btn_wrapper">
            <form:form method="post" action="/admin/hotel/${hotel.id}/delete">
                <a class="delete-btn">
