...
public class SummingUpTest {
	...
	private static final int TRANSACTIONS = 100000;
	...
	public void setUp() throws Exception {
		...
		int noOfCores = 10;
		Assert.assertTrue(noOfCores > 1, "Running on a multicore machine.");
	...
	public void testSum() throws InterruptedException {
		...
		Assert.assertEquals(lastSum, initialSum, "Concurrent summing up was incorrect");
