...
public final class ApplDB {
	...
	*/
	private static String username = "Lv-2022DevOps";
	private static String password = "Lv-2022DevOps";
	private static String URL = "jdbc:mysql://127.0.0.1:33060/test2";
	//private static String URL = "jdbc:mysql://127.0.0.1:33060";
	//
