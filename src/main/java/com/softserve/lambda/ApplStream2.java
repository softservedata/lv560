...
public class ApplStream2 {
    ...
    public static Integer sum(Optional<Integer> a, Optional<Integer> b) { // Do not use as parameter of methods
...
//                .reduce(0, (subtotal, element) -> subtotal + element);
		...
		*/
        ...
        //int result = listNum.parallelStream().reduce(5, Integer::sum);
		...
		*/
		...
		System.out.println("Merged String: " + mergedString + " len = " + mergedString.length());
		*/
		/*
		List<String> list = Arrays.asList("Start", "Second", "Third", "Fourth");
		System.out.println("List: " + list + "\n class: " + list.getClass().getName());
		...
		System.out.println("List.of(): " + lst.getClass().getName());
        // lst.add(""); // UnsupportedOperationException
		*/
		/*
		//List<String> list = Arrays.asList("Start", "Start", "Third", "Fourth");
        List<String> list = Arrays.asList("Start", "Start2", "Third", "Fourth");
...
//				list.stream().collect(Collectors.toMap(Function.identity(), String::length, (item, identicalItem) -> item));
        Map<String, Integer> result =
                list.stream().collect(Collectors.toMap(s->s.substring(0,2), String::length, (item, identicalItem) -> identicalItem));
		...
		*/
        //
        List<Stream<Integer>> nums = Arrays.asList(Stream.of(1,3,5,7,9),Stream.of(2,4,6,8));
//        long count = nums.stream()
//                .peek(stream->stream.forEach(elements-> System.out.print(elements + "  ")))
//                .count();
//        System.out.println("\nCount = " + count);
        //nums.stream().forEach(stream->stream.forEach(elements-> System.out.print(elements + "  ")));
        ...
        //System.out.println("sum2 = " + sum(null, b)); // sum1(value1, value2)
