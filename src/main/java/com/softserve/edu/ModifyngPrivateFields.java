...
public class ModifyngPrivateFields {
    ...
    public static void main(String[] args) throws Exception {
        // Hahaha h = new Hahaha();
        //WithPrivateFinalField pf0 = new WithPrivateFinalField();
        ...
        System.out.println("mods = " + f.getModifiers());
        f.setAccessible(true);
        System.out.println("f.setAccessible(true); mods = " + f.getModifiers());
        f.setInt(pf, 47);
        System.out.println(pf);
        */
        // /*
        ...
        */
        ...
        f = WithPrivateFinalField.class.getDeclaredField("m");
        f.setAccessible(true);
        //f.setInt(null, 222); // Ok if not final
        f.setInt(pf, 222); // Ok if not final
        // f.set(pf, 130); // ERROR
        System.out.println("m= " + f.getInt(pf) + "\n" + pf);
        //System.out.println("m= " + f.getInt(pf0) + "\n" + pf0 + " from pf0");
        */
        /*
