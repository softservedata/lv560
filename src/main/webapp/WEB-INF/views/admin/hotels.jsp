            ...
            <c:forEach var="hotel" items="${hotels}">
                <div class="entity-item-wrapper">
                    <div class="entity-item">
                        <a class="entity-link" href="/admin/hotel/${hotel.id}">${hotel.name}</a>
                    </div>
                </div>
            </c:forEach>
        </div>
...
<div class="new-entity-btn">
    <a href="/admin/hotels/new_hotel">
        <button class="icon-btn sticky-add-btn">
            <div class="add-icon"></div>
            <div class="btn-txt">Add hotel</div>
        </button>
    </a>
</div>
