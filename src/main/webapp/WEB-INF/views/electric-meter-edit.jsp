...
<form method="post" action="/${owner_id}/getresult/electric-meter/${electricMeter.id}" commandName="electricMeter">
        ...
        <tr>
            <td>
                ...
                <div align="center" class="mb-3" style="margin-left: 10px">
                    <input type="text" name="reading" class="form-control" placeholder="${electricMeter.reading}"
                           required="required">
                </div>
