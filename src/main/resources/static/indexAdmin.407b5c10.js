...
})({"lsuuI":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "b9346c83407b5c10";
...
},{}],"jgf4T":[function(require,module,exports) {
var _formRoom = require("./js/formRoom");
var _formMovie = require("./js/formMovie");
var _adminPage = require("./js/adminPage");

},{"./js/formRoom":"04wgp","./js/formMovie":"5Twz7","./js/adminPage":"jhWF5"}],"04wgp":[function(require,module,exports) {
var _refsAdmin = require("./refsAdmin");
var _api = require("./API/api");
const formValues = {
    name: "",
    numberOfSeats: null
};
(0, _refsAdmin.refs).form.addEventListener("submit", handleSubmit);
function handleSubmit(e) {
    e.preventDefault();
    if (e.target.nameOf.value.trim() && e.target.numberOf.value) {
        formValues.name = e.target.nameOf.value.trim();
        formValues.numberOfSeats = e.target.numberOf.value;
    }
    (0, _api.dataPostRoom)(formValues);
    e.currentTarget.reset();
}

},{"./refsAdmin":"8YcaT","./API/api":"c7ya5"}],"8YcaT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "refs", ()=>refs);
const refs = {
    userList: document.querySelector(".users-list"),
    form: document.querySelector(".addRoom"),
    sessionForm: document.querySelector(".addSession"),
    selectMovieName: document.querySelector("#nameOfMovie"),
    selectRoom: document.querySelector("#nameOfRoom"),
    selectDate: document.querySelector("#sessionDate")
};
...
parcelHelpers.export(exports, "sessionBsByData", ()=>sessionBsByData);
parcelHelpers.export(exports, "sessionByDataAndTime", ()=>sessionByDataAndTime);
parcelHelpers.export(exports, "dataSeats", ()=>dataSeats);
parcelHelpers.export(exports, "dataAdmin", ()=>dataAdmin);
parcelHelpers.export(exports, "dataPostBook", ()=>dataPostBook);
parcelHelpers.export(exports, "dataPostRoom", ()=>dataPostRoom);
parcelHelpers.export(exports, "dataAllMovies", ()=>dataAllMovies);
parcelHelpers.export(exports, "dataAllRooms", ()=>dataAllRooms);
parcelHelpers.export(exports, "dataAllDates", ()=>dataAllDates);
parcelHelpers.export(exports, "dataPostSession", ()=>dataPostSession);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const URL = "http://localhost:8881/api/";
(0, _axiosDefault.default).defaults.baseURL = URL;
const datas = async ()=>{
    try {
        const server = await (0, _axiosDefault.default).get(`session/dates`);
...
const sessionBsByData = async (sessionsData)=>{
    try {
        const server = await (0, _axiosDefault.default).get(`session/${sessionsData}`);
        const data = await server.data;
        console.log("sessionBsByData", data);
        return data;
    } catch (error) {
        console.error(error);
    }
};
const sessionByDataAndTime = async (sessionsData, sessionTime)=>{
    try {
        const server = await (0, _axiosDefault.default).get(`session/${sessionsData}/${sessionTime}`);
        const data = await server.data;
        console.log("sessionByDataAndTime", data);
        return data;
    } catch (error) {
        console.error(error);
    }
};
const dataSeats = async (sessionsData, sessionTime)=>{
    try {
        const server = await (0, _axiosDefault.default).get(`session/${sessionsData}/${sessionTime}/seats`);
        const data = await server.data;
...
const dataAdmin = async ()=>{
    try {
        const server = await (0, _axiosDefault.default).get(`admin/user/all`);
        const data = await server.data;
...
const dataPostBook = async (date, time, book)=>{
    try {
        const server = await (0, _axiosDefault.default).post(`session/${date}/${time}/book`, book);
        const data = await server.data;
        console.log("dataAdmin", data);
        return data;
    } catch (error) {
...
const dataPostRoom = async (book)=>{
    try {
        const server = await (0, _axiosDefault.default).post(`room/create`, book);
        const data = await server.data;
        console.log("dataPostRoom", data);
        return data;
    } catch (error) {
        console.error(error);
    }
};
const dataAllMovies = async ()=>{
    try {
        const server = await (0, _axiosDefault.default).get(`movie/all`);
        const data = await server.data;
        console.log("dataAllMovies", data);
        return data;
    } catch (error) {
        console.error(error);
    }
};
const dataAllRooms = async ()=>{
    try {
        const server = await (0, _axiosDefault.default).get(`room/all`);
        const data = await server.data;
        console.log("dataAllRooms", data);
        return data;
    } catch (error) {
        console.error(error);
    }
};
const dataAllDates = async ()=>{
    try {
        const server = await (0, _axiosDefault.default).get(`session/generate-dates/5`);
        const data = await server.data;
        console.log("dataAllDates", data);
        return data;
    } catch (error) {
        console.error(error);
    }
};
const dataPostSession = async (session)=>{
    try {
        const server = await (0, _axiosDefault.default).post(`session/create`, session);
        const data = await server.data;
        console.log("dataPostSession", data);
        return data;
    } catch (error) {
        console.error(error);
    }
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5Twz7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderMoviesNames", ()=>renderMoviesNames);
parcelHelpers.export(exports, "renderRoomsNames", ()=>renderRoomsNames);
parcelHelpers.export(exports, "renderDates", ()=>renderDates);
var _refsAdmin = require("./refsAdmin");
var _api = require("./API/api");
const formValues = {
    movieId: null,
...
async function movieNameFields() {
    const allMovies = await (0, _api.dataAllMovies)();
    const allRooms = await (0, _api.dataAllRooms)();
    const allDates = await (0, _api.dataAllDates)();
    renderMoviesNames(allMovies);
    renderRoomsNames(allRooms);
    renderDates(allDates);
}
async function renderMoviesNames(datas) {
    datas.map((data)=>{
        const option = `<option
              class="change-lng__item change-lng__item--en"
              value=${data.id}
            >
              ${data.name}
            </option>`;
        (0, _refsAdmin.refs).selectMovieName.insertAdjacentHTML("beforeend", option);
    }).join("");
}
async function renderRoomsNames(datas) {
    datas.map((data)=>{
        const option = `<option
              class="change-lng__item change-lng__item--en"
              value=${data.id}
        ...
        (0, _refsAdmin.refs).selectRoom.insertAdjacentHTML("beforeend", option);
    }).join("");
}
async function renderDates(datas) {
    datas.map((data)=>{
        const option = `<option
              class="change-lng__item change-lng__item--en"
              value=${data}
        ...
        (0, _refsAdmin.refs).selectDate.insertAdjacentHTML("beforeend", option);
    }).join("");
}
movieNameFields();
(0, _refsAdmin.refs).sessionForm.addEventListener("submit", handleSubmit);
function handleSubmit(e) {
    e.preventDefault();
    formValues.movieId = e.target.nameOfMovie.value;
    formValues.roomId = e.target.nameOfRoom.value;
    formValues.date = e.target.sessionDate.value;
    formValues.time = e.target.sessionTime.value;
    (0, _api.dataPostSession)(formValues);
    e.currentTarget.reset();
}

},{"./refsAdmin":"8YcaT","./API/api":"c7ya5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jhWF5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderDatas", ()=>renderDatas);
var _refsAdmin = require("./refsAdmin");
var _api = require("./API/api");
var _malePng = require("../images/male.png");
var _malePngDefault = parcelHelpers.interopDefault(_malePng);
var _femalePng = require("../images/female.png");
var _femalePngDefault = parcelHelpers.interopDefault(_femalePng);
dataForRender();
async function dataForRender() {
    const dataUsers = await (0, _api.dataAdmin)();
    renderDatas(dataUsers);
}
async function renderDatas(datas) {
    let img = null;
    datas.map((data)=>{
        if (data.gender === "MALE") img = (0, _malePngDefault.default);
        if (data.gender === "FEMALE") img = (0, _femalePngDefault.default);
        const card = `<li class="user-item">
        <img src=${img} alt="" class="chair-icon" width="50" height="50">
        <p class="user-name">${data.email}</p>
        <div class="order-infobox order-infobox${data.id}">
        </div>
      </li>`;
        (0, _refsAdmin.refs).userList.insertAdjacentHTML("beforeend", card);
        const infobox = document.querySelector(`.order-infobox${data.id}`);
        booksCicle(data.books, infobox);
    }).join("");
}
function booksCicle(data, container) {
    let item1 = null;
    if (data.length === 0) {
        item1 = `<p class="no-books">
             'No books yet 😢(((('
            </p>`;
        container.insertAdjacentHTML("beforeend", item1);
    }
    data.map((dataItem)=>{
        const item = `
          <div class="order-info">
            <p class="movie-name">
              Movie: <span class="movie-name-text">${dataItem.movieName}</span>
            </p>
            <p class="movie-date">
              Date: <span class="movie-date-text">${dataItem.date}</span>
            </p>
            <p class="movie-time">
              Time: <span class="movie-time-text">${dataItem.time}</span>
            </p><span class="chairs-shosen chairs-shosen${dataItem.id}"
              >Chair:</span>
          </div>`;
        container.insertAdjacentHTML("beforeend", item);
        const box = document.querySelector(`.chairs-shosen${dataItem.id}`);
        seatsCicle(dataItem.seatNumbers, box);
    }).join("");
}
function seatsCicle(data, container) {
    data.map((dataItem)=>{
        const item = `<span class="chair">${dataItem}</span>`;
        container.insertAdjacentHTML("beforeend", item);
    }).join("");
}

},{"./refsAdmin":"8YcaT","./API/api":"c7ya5","../images/male.png":"8ZQNO","../images/female.png":"ezlHn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8ZQNO":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("fTQ7E") + "male.feab8452.png" + "?" + Date.now();
...
},{}],"ezlHn":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("fTQ7E") + "female.7bb810a9.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}]},["lsuuI","jgf4T"], "jgf4T", "parcelRequire0977")

//# sourceMappingURL=indexAdmin.407b5c10.js.map
